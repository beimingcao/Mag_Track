...
while (<M>) {
  ...
  next if ($_ =~ /^breath\s*.*$/); # Ignore glottal stops.
  next if ($_ =~ /^sil\s*.*$/); # Ignore glottal stops.
...
while (<T>) {
  ...
  $trans =~ s/sil breath//g;  # Remove glottal stops.
  $trans =~ s/eir/eh r/g;  # Remove glottal stops.
  $trans =~ s/oo/ao r/g;  # Remove glottal stops.
  $trans =~ s/i@/ih er/g;  # Remove glottal stops.
#  $trans =~ s/sil sil//g;  # Remove glottal stops.
