...
shrink=true
num_frames_shrink=1000 # note: must be <= --num-frames-diagnostic option to get_egs.sh, if
                       # given.
final_learning_rate_factor=0.5 # Train the two last layers of parameters half as
                               # fast as the other layers.

hidden_layer_dim=512 #  You may want this larger, e.g. 1024 or 2048. was 300
...
add_layers_period=5 # by default, add new layers every 2 iterations.
num_hidden_layers=5
