...
if [ $stage -le 1 ]; then
  ...
  dir=$CV/exp/lstm4-ivec${ivec_dim}-${mono_tri}_${nGauss}_splice0_nstream10_celdim${cell}_pdim400_nlayer2_lrate0.00004
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train.sh --network-type lstm --learn-rate 0.00004 \
      ...
      --proto-opts "--cell-dim ${cell} --proj-dim 400 --num-layers 2" \
