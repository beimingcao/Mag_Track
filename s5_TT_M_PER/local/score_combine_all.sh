...
echo ============================================================================
echo "                    System Combination (MFCCs+MVs)                         "
echo ============================================================================
for modelname in mono tri1 tri2 tri3 sgmm2_4; do
  local/score_combine.sh --cmd "$decode_cmd" \
   data/test data/lang_test_bg exp/$modelname/decode_test \
   $1/exp/$modelname/decode_test exp/combine_$modelname/decode_test
done
exit 0;
echo ============================================================================
