...
if [ $stage -le 1 ]; then
  ...
  dir=$CV/exp/lstm4-${mono_tri}_splice0_nstream10_celdim640_pdim400_nlayer2
  ...
  $cuda_cmd $dir/log/train_nnet.log \
    steps/nnet/train.sh --network-type lstm --learn-rate 0.00008 \
      ...
      --proto-opts "--cell-dim 640 --proj-dim 400 --num-layers 3" \
